...
#include "totalFlowRateAdvectiveDiffusiveTransport.H"
...
totalFlowRateAdvectiveDiffusiveTransport
(
    const totalFlowRateAdvectiveDiffusiveTransport& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
totalFlowRateAdvectiveDiffusiveTransport
(
    const totalFlowRateAdvectiveDiffusiveTransport& tppsf
)
:
...
void Foam::totalFlowRateAdvectiveDiffusiveTransport::autoMap
(
...
void Foam::totalFlowRateAdvectiveDiffusiveTransport::rmap
(
...
void Foam::totalFlowRateAdvectiveDiffusiveTransport::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
void Foam::totalFlowRateAdvectiveDiffusiveTransport::
